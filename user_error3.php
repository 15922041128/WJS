...
<div class="ui-widget" style="margin:auto auto; width:300px;" >
			<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
				...
				<?php echo $multilingual_error_permissions; ?> <a href="javascript:history.go(-1)"><?php echo $multilingual_global_action_back; ?></a> / <a href="user_login.php"><?php echo $multilingual_error_login; ?></a></p>
			</div>
		</div>
</body>
</html>