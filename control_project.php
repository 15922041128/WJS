...
// wangzi modify
if ($pagetabs == "mprj" || $pagetabs == "jprj" || $pagetabs == "cprj"){
...
// wangzi modify 
else if ($pagetabs == "cprj") {
$where = "project_from_user = $prjtouser AND tk_status_project.task_status NOT LIKE '%%$multilingual_dd_status_prjfinish%%' AND";
}else{
