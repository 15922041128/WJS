...
<?php/*wangzi modify*/?>
<?php if($_SESSION['MM_rank'] > "4" || $row_Recordset_log['project_to_user'] == $_SESSION['MM_uid']) { ?>
	<a href="project_view.php?recordID=<?php echo $row_Recordset_log['csa_project']; ?>"><?php echo $row_Recordset_log['project_name']; ?></a>
<?php } else {?>
