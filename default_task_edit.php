...
mysql_select_db($database_tankdb, $tankdb);
// wangzi modify
$query_Recordset_pattask = "SELECT * FROM tk_task inner join tk_task_tpye on tk_task.csa_type=tk_task_tpye.id " .
		"inner join tk_project on tk_task.csa_project = tk_project.id " .
		"WHERE TID = '$pattaskid'";
...
// wangzi modify
$task_arr['projectUser'] = $row_Recordset_task['project_to_user'];
...
?></td>
	...
	<?php } ?>
        ...
        <tr>
		  ...
		  <tr>
		  	<?php/*wangzi modify*/?>
            <?php if($_SESSION['MM_rank'] > "4" || $row_Recordset_task['project_to_user'] == $_SESSION['MM_uid'] || $row_Recordset_task['csa_to_user'] == $_SESSION['MM_uid'] ) { ?>
			<td width="16%">
